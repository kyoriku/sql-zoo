...
-- 9. Show the name and population in millions and the GDP in billions for the countries of the continent 'South America'. Use the ROUND function to show the values to two decimal places (https://sqlzoo.net/wiki/ROUND). For Americas show population in millions and GDP in billions both to 2 decimal places.
...
-- You can use the LENGTH function to find the number of characters in a string. (https://sqlzoo.net/wiki/LENGTH)
...
-- You can use the function LEFT to isolate the first character. (https://sqlzoo.net/wiki/LEFT)
